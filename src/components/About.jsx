      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="md:col-span-1 row-span-2 relative rounded-3xl overflow-hidden border border-white/10 group"
          >
          ...
          <motion.div
            ...
            className="md:col-span-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 flex flex-col justify-center hover:bg-white/10 transition-colors duration-300"
          >
          ...
          <motion.div
            ...
            className="bg-[#1a1a1a] border border-white/10 rounded-3xl p-6 flex flex-col items-center justify-center relative overflow-hidden group"
          >
