    ...
    <section id="contact" className="py-32 animated-bg relative overflow-hidden">
      ...
      >
        ...
        <motion.div className="grid lg:grid-cols-2 gap-16">
          <motion.div variants={formVariants} className="bg-white/5 backdrop-blur-sm p-8 rounded-3xl border border-white/10">
            <motion.h3
            ...
            >
              <motion.div className="grid md:grid-cols-2 gap-6" variants={containerVariants}>
                <motion.div className="relative group" variants={containerVariants}>
                  <FontAwesomeIcon icon={faUser} className="absolute left-0 top-4 text-gray-500 group-focus-within:text-white transition-colors" />
                  <motion.input
                    type="text"
                    name="name"
                    ...
                    className="w-full pl-8 pr-4 py-4 bg-transparent border-b border-white/20 text-white placeholder-gray-500 focus:outline-none focus:border-white transition-all duration-300"
                    required
                  />
                </motion.div>
                <motion.div className="relative group" variants={containerVariants}>
                  <FontAwesomeIcon icon={faEnvelope} className="absolute left-0 top-4 text-gray-500 group-focus-within:text-white transition-colors" />
                  <motion.input
                    type="email"
                    name="email"
              ...
              <motion.div className="relative group" variants={containerVariants}>
                <FontAwesomeIcon icon={faTag} className="absolute left-0 top-4 text-gray-500 group-focus-within:text-white transition-colors" />
                <motion.input
                  type="text"
                  name="subject"
                  placeholder="Subject"
              ...
              <motion.div className="relative group" variants={containerVariants}>
                <FontAwesomeIcon icon={faCommentDots} className="absolute left-0 top-4 text-gray-500 group-focus-within:text-white transition-colors" />
                <motion.textarea
                  rows="4"
                  name="message"
                  ...
                  onChange={handleChange}
                  variants={inputVariants}
                  className="w-full pl-8 pr-4 py-4 bg-transparent border-b border-white/20 text-white placeholder-gray-500 focus:outline-none focus:border-white transition-all duration-300 resize-none"
                  required
                ></motion.textarea>
              </motion.div>
              ...
              <motion.button
                ...
                whileTap="tap"
                disabled={loading}
                className="w-full py-4 bg-white text-black font-medium tracking-wide rounded-xl hover:bg-gray-200 transition-colors disabled:opacity-50"
              >
                {loading ? (
                  <motion.div
                    animate={{ rotate: 360 }}
              ...
              <AnimatePresence>
                {successMessage && (
                  <motion.div
                    ...
                    className="text-green-400 text-sm text-center bg-green-400/10 p-3 rounded-lg"
                  >
                    {successMessage}
                  </motion.div>
                )}
